		...
		<div className="mt-10 flex h-[50px] w-[600px] max-w-[95%] items-center justify-between rounded-lg bg-gray-800 p-5">
			<Typewriter
				options={{
					...
					strings: [
						...
						"Unleash your productivity with OmniAgent's AI guidance.",
						"Simplify and supercharge your tasks with OmniAgent AI.",
						"Elevate your efficiency with OmniAgent's personalized AI support.",
						"Unlock your potential with OmniAgent's intelligent assistance.",
						"Navigate the digital realm effortlessly with OmniAgent AI.",
						"Your trusted AI companion for seamless productivity.",
						"Maximize your capabilities with OmniAgent's smart guidance.",
						"Accelerate your success with OmniAgent's AI-driven support.",
						"Seize control of your digital experience with OmniAgent AI.",
					],
				}}
			/>
			...
			<ActionIcon
				...
				onClick={() => {
					showNotification({
						color: "red",
						message: "OmniAgent is still in development.",
						title: "Coming soon!",
					});
				}}
				variant="light"
