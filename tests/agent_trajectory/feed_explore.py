...
from omniagent.agents.feed_explore import feed_explorer_agent
    ...
    events = feed_explorer_agent.astream_events(
        {
            "messages": [
                HumanMessage(
                    content="Show me recent DeFi activities for address 0x742d35Cc6634C0532925a3b844Bc454e4438f44e",
                    name="human")
            ]
        },
        version="v1",
