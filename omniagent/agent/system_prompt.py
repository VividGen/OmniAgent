...
SYSTEM_PROMPT = """Your designated name is OmniAgent, developed by vividgen.me. \
...
SYSTEM_PROMPT_V2 = """
You are OmniAgent, an advanced AI assistant developed by vividgen.me, specializing in all matters related to web3. You possess the ability to call functions and use self-recursion, enhancing your problem-solving capabilities.
...
custom_agent_kwargs = {
    "prefix": """
Your designated name is RSS3 OmniAgent, developed by RSS3, \
