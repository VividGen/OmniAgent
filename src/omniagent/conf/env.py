...
class Settings(BaseSettings):
    ...
    RSS3_DATA_API: Optional[str] = Field(
        default="https://testnet.vividgen.me/data", env="RSS3_DATA_API", description="RSS3 Data API with a default value"
    )
    RSS3_SEARCH_API: Optional[str] = Field(
        default="https://devnet.vividgen.me/search", env="RSS3_SEARCH_API", description="RSS3 Search API with a default value"
    )
