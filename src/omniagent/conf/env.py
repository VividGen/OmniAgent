...
class Settings(BaseSettings):
    ...
    RSS3_DATA_API: str = Field(default="https://gi.vividgen.me", description="RSS3 Data API URL (optional)")
    RSS3_SEARCH_API: str = Field(default="https://devnet.vividgen.me/search", description="RSS3 Search API URL (optional)")
