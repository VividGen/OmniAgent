...
class Settings(BaseSettings):
    ...
    VERTEX_PROJECT_ID: Optional[str] = Field(default=None,
                                             description="Google Cloud Vertex project ID. Info: https://cloud.google.com/vertex-ai/docs/reference")
    ...
    GOOGLE_GEMINI_API_KEY: Optional[str] = Field(default=None,
                                                 description="Google Gemini API Key. Info: https://ai.google.dev")
    OLLAMA_HOST: Optional[str] = Field(default=None,
                                       description="OLLAMA API Base URL. Info: https://github.com/ollama/ollama")
    ...
    COVALENT_API_KEY: Optional[str] = Field(default=None,
                                            description="Covalent API Key. Info: https://goldrush.dev/docs/api/")
    ROOTDATA_API_KEY: Optional[str] = Field(default=None,
                                            description="RootData API Key. Info: https://www.rootdata.com/")
    COINGECKO_API_KEY: Optional[str] = Field(default=None,
                                             description="CoinGecko API Key. Info: https://www.coingecko.com/en/api/pricing")
