...
class Settings(BaseSettings):
    ...
    VERTEX_PROJECT_ID: Optional[str] = Field(default=None,
                                             description="Google cloud vertex project id (optional)")
    OPENAI_API_KEY: Optional[str] = Field(default=None, env="OPENAI_API_KEY",
                                          description="OpenAI API Key (optional)")
    # Local LLM configuration
    OLLAMA_MODEL: Optional[List[str]] = Field(default=None, env="OLLAMA_MODEL",
                                              description="OLLAMA Model list (optional)")
    OLLAMA_MODEL_URL: Optional[str] = Field(default=None, env="OLLAMA_MODEL_URL",
                                            description="OLLAMA Model URL (optional)")

    # Tool API Keys
    NFTSCAN_API_KEY: Optional[str] = Field(..., env="NFTSCAN_API_KEY", description="NFTScan API Key (optional)")
    RSS3_DATA_API: Optional[str] = Field(default="https://testnet.vividgen.me/data", env="RSS3_DATA_API",
                                         description="RSS3 Data API with a default value")
    RSS3_SEARCH_API: Optional[str] = Field(default="https://devnet.vividgen.me/search", env="RSS3_SEARCH_API",
