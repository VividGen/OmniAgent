...
class ParamSchema(BaseModel):
    ...
    from_chain: ChainEnum = Field(default=ChainEnum.ETH, description="Blockchain network to swap from. Default: 'ETH'.")
    to_chain: ChainEnum = Field(default=ChainEnum.ETH, description="Blockchain network to swap to. Default: 'ETH'.")
