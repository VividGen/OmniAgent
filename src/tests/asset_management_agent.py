...
class TestAssetManagementAgent(unittest.TestCase):
    ...
    def test_swap_eth_to_usdt(self):
        async def async_test():
            events = asset_management_agent.astream_events({"messages": [
                HumanMessage(content="Can you swap 20 eth to usdt ?", name="human")]},
                version="v1")
    ...
    def test_query_user_token_balance(self):
        async def async_test():
            events = asset_management_agent.astream_events({"messages": [
                HumanMessage(content="Can you check 0x33c0814654fa367ce67d8531026eb4481290e63c eth balance ?",
                             name="human")]},
                version="v1")
    ...
    def test_query_user_nft_holdings(self):
        async def async_test():
            events = asset_management_agent.astream_events({"messages": [
                HumanMessage(content="Can you check 0x33c0814654fa367ce67d8531026eb4481290e63c nft holdings ?",
                             name="human")]},
                version="v1")
