...
import {OmniAgentToken} from "../../src/mocks/OmniAgentToken.sol";
...
contract CommonTest is Utils {
    OmniAgentToken public token;
    OmniAgentExecutorManager internal _manager;
    ...
    function _deployContracts() internal {
        // deploy token
        token = new OmniAgentToken();
        // deploy and init OmniAgentExecutorManager contract
        ...
        _manager = OmniAgentExecutorManager(payable(address(proxy)));
    }
}
