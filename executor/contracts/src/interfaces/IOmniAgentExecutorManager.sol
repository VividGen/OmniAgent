...
interface IOmniAgentExecutorManager {
    /**
     * @notice Initializes the OmniAgentExecutorManager, setting the admin address.
    ...
    /**
     * @notice Deposits tokens to the OmniAgent executor contract.
    ...
    /**
     * @notice Withdraws tokens from the OmniAgent executor contract.
    ...
    /**
     * @notice Returns the balance of a user in the OmniAgent executor contract.
     * @param userId The ID of the user.
     * @param executorId The ID of the executor.
